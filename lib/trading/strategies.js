...
// Core strategy watchlist — focused on high-conviction assets
const MONITORED_SYMBOLS = ['BTC-USD', 'ETH-USD', 'SOL-USD', 'AVAX-USD', 'LINK-USD'];
...
async function getAllSignals(coinbaseClient, heldSymbols = []) {
  // Merge fixed watchlist with held coins, deduplicate, skip stablecoins
