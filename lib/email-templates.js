              ...
              <table role="presentation" style="margin: 30px auto; text-align: center;">
                <tr>
                  <td style="background-color: #FF5A5F; border-radius: 6px; text-align: center;">
                    <a href="https://arterycapital.co.za" style="display: inline-block; padding: 14px 32px; color: #ffffff; text-decoration: none; font-size: 16px; font-weight: 600;">
                      Visit Our Website
                    </a>
                  </td>
                </tr>
        ...
        <table role="presentation" style="max-width: 700px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="padding: 30px; text-align: center; border-top: 1px solid #E5E7EB;">
              ...
              <a href="https://arterycapital.co.za/admin" style="display: inline-block; margin: 0 10px; padding: 12px 24px; background-color: #2C2C2C; color: #ffffff; text-decoration: none; border-radius: 6px; font-size: 14px; font-weight: 600;">
                View in Dashboard
              </a>
            </td>
          </tr>
