        ...
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: '40px 32px', display: 'flex', flexDirection: 'column', gap: 24 }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2">
              <LiveChart snapshots={status?.snapshots || []} initialCapital={status?.portfolio?.initialCapital} />
            </div>
            <div>
              <StrategyControls riskMetrics={status?.riskMetrics} onRunCron={() => fetchStatus()} onResetBaseline={() => fetchStatus()} />
            </div>
          </div>
